...
A new form based configuration was introduced to replace the configuration based on the environment variables.
To ensure the correct functioning of the auto-injection functionality the following global environment variables must be removed:

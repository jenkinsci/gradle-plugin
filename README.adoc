...
It also allows detecting https://gradle.com/build-scans/[Develocity] in arbitrary console logs, for Maven and Gradle builds and display them in the Jenkins UI.
...
[IMPORTANT]
=====
Develocity 2024.1 or above is required starting from version `2.12` and above. See <<_common_configuration_options>> for more infos.
=====

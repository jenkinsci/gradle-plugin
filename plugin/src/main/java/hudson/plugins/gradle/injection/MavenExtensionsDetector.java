...
public class MavenExtensionsDetector {
    ...
    static Set<MavenExtension> detect(InjectionConfig config, FilePath workspace)
        ...
        if (extensionsFile.exists()) {
            ...
            if (mavenExtensions.hasExtension(MavenExtension.DEVELOCITY.getCoordinates())
                    ...
                    || mavenExtensions.hasExtension(
                            MavenCoordinates.parseCoordinates(config.getMavenExtensionCustomCoordinates()))) {
            ...
            if (mavenExtensions.hasExtension(MavenExtension.CCUD.getCoordinates())
                    || mavenExtensions.hasExtension(
                            MavenCoordinates.parseCoordinates(config.getCcudExtensionCustomCoordinates()))) {
